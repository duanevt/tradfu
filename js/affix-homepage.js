...
function doAffixAndScrollSpyStuff() {
	...
	var heightOfSmallestBanner = 717;  // this is the height of the banner/hero image and/or anything else that may appear above the affixed object (not including the height menu bar) - note that the height may change when the screen is narrow
	var heightOfLargestBanner = 982;   // this is the height of the banner/hero image when the screen is at its widest
